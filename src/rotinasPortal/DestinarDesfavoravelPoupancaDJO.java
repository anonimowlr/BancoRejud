...
import dao.DestinarDesfavoravelPoupancaDjoDAO;
 ...
 * @author f5078775
 */
public class DestinarDesfavoravelPoupancaDJO extends Thread {
    ...
    DestinarDesfavoravelPoupancaDjoDAO<Resgate> destinarDesfavoravelPoupancaDAO = new DestinarDesfavoravelPoupancaDjoDAO<>(bancoDados);
    Coletas coletas = new Coletas();
    Usuario user = new Usuario();

    public DestinarDesfavoravelPoupancaDJO() {
    }
    ...
    public void run() {
        ...
        try {
            ...
            Logger.getLogger(DestinarDesfavoravelPoupancaDJO.class.getName()).log(Level.SEVERE, null, ex);
        }
        coletas.setSize();
        JOptionPane.showMessageDialog(null, "Fim de rotina desfavoráveis poupança");
    ...
    public void createList() {
        ...
        try {
            lista = destinarDesfavoravelPoupancaDAO.buscar();
            if (lista.size() < 1) {
                JOptionPane.showMessageDialog(null, "Não há registros para contabilizar desfavoráveis Poupança");
            } else {
    ...
    public void lerLista() throws SQLException {
        ...
        for (Resgate s : lista) {
            ...
            String especificacao = "Diferenca de Rendimentos - Planos - Poupanca ";
    ...
    public void procuraResgatePortalDestinacao(String levantador, String finalidade, String especificacao, String favorecido, String npj, String contaDepositaria, String valorResgate, String ordem, int codigo) {
        ...
        if (coletas.isElementPresentID(driver, "modaldivMessagesGlobal")) {
            ...
            if (!n.equals("")) {
                ...
                destinarDesfavoravelPoupancaDAO.editarGenerico("tb_cpj_cadastro", "OBS_CONTABILIZACAO", n, codigo);
                return;
            }
        }
        ...
        for (int reg = 0; reg < qtdreg; reg++) {
            ...
            if (valorResgate.equals(Utils.tratarVariavel(valorResgatePortal)) && ordem.equals(ordemPortal) && contaDepositariaPortal.equals(contaDepositaria)) {
                ...
                if(coletas.isElementPresentID(driver, "pesquisarSolicitacaoLevantamentoDepositoForm:dataTabletablesolicitacaoResgate:" + reg + ":seta")){
                 ...
                 destinarDesfavoravelPoupancaDAO.editarGenerico("tb_cpj_cadastro", "OBS_CONTABILIZACAO", "Sem seta para destinar", codigo); 
                 return;
                }
...
// -------------- alterado incluirDepositoAdversoForm para incluirDestinacaoForm --------------
                while(coletas.isElementPresentID(driver, "incluirDestinacaoForm:btSalvar")){
                    coletas.clickElementId(driver, "incluirDestinacaoForm:btSalvar");
                    if (coletas.isElementPresentID(driver, "modaldivMessagesGlobal")) {
