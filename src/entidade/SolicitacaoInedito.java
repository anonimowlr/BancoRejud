...
@NamedQueries({
    @NamedQuery(name = "SolicitacaoInedito.findAll", query = "SELECT s FROM SolicitacaoInedito s")})
public class SolicitacaoInedito implements Serializable {
    ...
    public SolicitacaoInedito() {
    }

    public SolicitacaoInedito(Integer codigo) {
        this.codigo = codigo;
    }

    public SolicitacaoInedito(Integer codigo, double vlRsgt) {
        this.codigo = codigo;
        this.vlRsgt = vlRsgt;
    }

    public SolicitacaoInedito(String npj, Integer variacaoNpj, double vlRsgt, String contaDepositaria,String funcionarioResponsavelSolicitacao, Date dataSolicitacao, String tipoDestinacao) {
    ...
    public double getVlRsgt() {
        return vlRsgt;
    }

    public void setVlRsgt(double vlRsgt) {
        this.vlRsgt = vlRsgt;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SolicitacaoInedito)) {
            return false;
        }
        SolicitacaoInedito other = (SolicitacaoInedito) object;
    ...
    public String toString() {
        return "pojo.SolicitacaoInedito[ codigo=" + codigo + " ]";
    }
