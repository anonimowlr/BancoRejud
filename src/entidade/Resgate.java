...
@NamedQueries({
    @NamedQuery(name = "Resgate.findAll", query = "SELECT r FROM Resgate r")})
public class Resgate implements Serializable {
    ...
    @Column(name = "ENVOLVIDO")
    private String envolvido;
    @Column(name = "VALOR_DESTINADO")
    private BigDecimal valorDestinado;
    @Column(name = "DATA_SINCRONIZACAO")
    @Temporal(TemporalType.DATE)
    private Date dataSincronizacao;
    @Temporal(javax.persistence.TemporalType.DATE)
    private Date dataRotinaDJOSequencial;

    public Resgate() {
    }

    public Resgate(Integer cod) {
        this.cod = cod;
    }
    ...
    public Date getDataRotinaDJOSequencial() {
        return dataRotinaDJOSequencial;
    }

    public void setDataRotinaDJOSequencial(Date dataRotinaDJOSequencial) {
        this.dataRotinaDJOSequencial = dataRotinaDJOSequencial;
    }
