...
public class LeituraSaldoContabilPortal extends Thread {
    ...
    public LeituraSaldoContabilPortal() {
    }
    ...
    public void createList() {
        ...
        lista = desconciliacaoDAO.buscarParaLerSaldo();
        if (lista.size() < 1) {
    ...
    private void coletaDadosPortal(Integer codigo, String npj, Integer variacaoNpj, String contaDepositaria) {
        ...
        if (qtdreg > 9) {
            ...
            JOptionPane.showConfirmDialog(null, "numero de registro maior que 9 desenvolva o metodo em leitura saldo contabil portal");
            return;
