 ...
 * @author suporte
 */
public class FormAtualizacaoRetab extends javax.swing.JFrame {

    
    public FormAtualizacaoRetab() {
        setPropriedades();
        initComponents();
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
        ...
        Thread thread = new Thread() {
            ...
            public void run() {      
                ...
                lblTitulo.setText("Atualização na base da ferramenta Web DJO RETAB - Início: " + Utils.getDataHoraAtualMysql());
                ...
                int k = JOptionPane.showConfirmDialog(null, "Registros web DJO - RETAB: " + qtdRetab
...
//                    desconciliacaoDAO.buscarRegistroTratatoAutomatico();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new FormAtualizacaoRetab().setVisible(true);
            }
        });
    }
