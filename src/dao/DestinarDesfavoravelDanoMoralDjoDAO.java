 ...
 * @param <E>
 */
public class DestinarDesfavoravelDanoMoralDjoDAO<E> {
     ...
     */
    public DestinarDesfavoravelDanoMoralDjoDAO(String bancoDados) {
    ...
    public List<Resgate> buscar() throws SQLException {
        ...
        try {
            ...
            String sql = "select * from view_tb_destinacao_dn_moral where OBS_CONTABILIZACAO IS NULL OR OBS_CONTABILIZACAO =''";
