...
public class Efetivacao implements Serializable {
    ...
    private BigDecimal valorEfetivacao;
    ...
    public BigDecimal getValorEfetivacao() {
        return valorEfetivacao;
    }

    public void setValorEfetivacao(BigDecimal valorEfetivacao) {
    ...
    public String toString() {
        return "pojo.Efetivacao[ codigo=" + codigo + " ]";
    }
